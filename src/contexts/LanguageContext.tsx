...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "feedback.description": "شارك رأيك حول EduMentor+",
    ...
    "feedback.success": "نجح",
    "feedback.thankYou": "شكراً لك على ملاحظاتك!",
    "feedback.error": "خطأ",
    "feedback.fillAll": "الرجاء تقديم التقييم والرسالة",
    "feedback.loginRequired": "الرجاء تسجيل الدخول لإرسال التقييم",
    "feedback.submitError": "فشل إرسال التقييم",
    
    "progress.completed": "مكتمل",
    "progress.started": "بدأ",
    "progress.inProgress": "قيد التقدم",
    "progress.notStarted": "لم يبدأ",
    
    "dashboard.title": "لوحة التحكم",
    "dashboard.noResults": "لا توجد نتائج تقييم",
    "dashboard.takeAssessment": "قم بإجراء التقييم أولاً لرؤية لوحة التحكم المخصصة",
    "dashboard.startAssessment": "ابدأ التقييم",
    "dashboard.yourProgress": "تقدمك",
    "dashboard.completedCourses": "الدورات المكتملة",
    "dashboard.continueLearning": "تابع التعلم",
    "dashboard.viewCourse": "عرض الدورة",
